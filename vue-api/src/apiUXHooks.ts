...
// The error-UX pipeline's half of @greendrake/vue-app's boot: spread into
// createSpaApp's options. The router is typed by the one method used, so this
// package takes no vue-router dependency.
